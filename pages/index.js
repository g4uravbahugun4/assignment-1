...
<div className='flex flex-col  border shadow-md rounded-lg   justify-center items-center '>
  ...
  <span className='p-8 w-4/5 flex justify-center items-center '>
                  <a className='px-2'> <img src='\icons8-facebook-24.png ' className='hover:cursor-pointer hover:w-10  w-8 h-5'/></a>
                  <a className='px-2'> <img src='\icons8-instagram-24.png' className='hover:w-10 hover:cursor-pointer w-8 h-5' />
                  </a> <a className='px-2'><img src='\icons8-twitter-30.png' className='hover:w-10 hover:cursor-pointer w-8 h-5' />
  </a></span>
...
<div className='flex flex-col  border shadow-md rounded-lg   justify-center items-center '>
  ...
  <span className='p-8 w-4/5 flex justify-center items-center '>
                  <a className='px-2'> <img src='\icons8-facebook-24.png' className='hover:w-10 hover:cursor-pointer w-8 h-5'/></a>
                  <a className='px-2'> <img src='\icons8-instagram-24.png' className='hover:w-10 hover:cursor-pointer w-8 h-5' />
                  </a> <a className='px-2'><img src='\icons8-twitter-30.png' className='hover:w-10 hover:cursor-pointer w-8 h-5' />
  </a>
  </span>
  ...
  <h1 className='font-semibold text-center'>PT Dwidasa Samsara IndonesiaRuko</h1>   Jalur Sutera 29A No. 53  Alam Sutera Serpong, Tangerang 15323 
   ...
   <h1 className='font-semibold text-center'>Contact</h1> 
    ...
    <div className=' p-3  flex flex-col justify-between self-center '>
      ...
      <img src='\image 9.png' className='h-8 ml-8'/>
      <img src='\image 10.png' className='h-8 ml-10' /></span>
      <span className='w-1/4 flex '>  
      <img src='\image 11.png' className='h-10' />
      <img src='\image 13.png' className='ml-8 mt-4 h-4' />
      <img src='\image 14.png' className='ml-10 mt-4 h-4' />
      </span>
